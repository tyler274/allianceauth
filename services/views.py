...
import json
from bosh.boshclient import BOSHClient
...
# 		bc = BOSHClient(authinfo.jabber_username + '@' + settings.JABBER_URL,
# 			authinfo.jabber_password, settings.BOSH_SERVICE)
# 		print "giant bag of dicks"
# 		print str(bc.logged_in)
# 		print bc.sid
# 		print bc.jid
# 		print bc.rid
...
# 			#'jid' : authinfo.jabber_username + '@' + settings.JABBER_URL ,
# 			#'pass' : authinfo.jabber_password}
# 			'jid': bc.jid,
# 			'sid': bc.sid,
# 			'rid': bc.rid,
# 			})  
