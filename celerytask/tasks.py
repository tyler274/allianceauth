...
# 									print "I say in the butt"
# 									print character.id
# 									print EveManager.get_character_by_id(authserviceinfo.main_char_id).character_id
# 									if character == EveManager.get_character_by_id(authserviceinfo.main_char_id).character_id:
# 										print "all up in this bitch"
...
# 											print 'failed checks'
# 											try:
# 												f = open('/home/bovril/allianceauth/log-of-left', 'w')
# 												s = str(character.character_name)
# 												f.write(s)
# 												f.close()
# 											except:
# 												pass
						...
						if True in valid_key:
							...
							if character:
								...
								if main_alliance_id == settings.ALLIANCE_ID:
									...
									if corp.is_blue is not True:
										print 'Not blue get rekt'
										deactivate_services(user)
										user.groups.clear()
								else:
									print 'No corp no problems'
									deactivate_services(user)
									user.groups.clear()
							else:
								deactivate_services(user)
